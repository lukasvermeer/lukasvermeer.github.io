...
Written down in Perl and compressed to fit into a [single tweet](https://twitter.com/lukasvermeer/status/9197883776) this [^1] can be expressed as:
...
[^1]: As my friend Daan [pointed out before](https://twitter.com/daanbroekhuizen/status/9218973798) my original tweet was not quite optimal; hence the different code in this post.
