...
header:
  alt: A teaser image for the Future Felony post.
  teaser_alt: A teaser image for the Future Felony post.
---

Written by [Arthur C. Clarke](https://en.wikipedia.org/wiki/Arthur_C._Clarke) in 1976, [Imperial Earth](https://en.wikipedia.org/wiki/Imperial_Earth) is set in faraway 2276.
...
The future sounds fascinating, but I want my [Google Driverless Car](https://en.wikipedia.org/wiki/Google_driverless_car) now.