...
header:
  ...
  alt: A teaser image for the Multiplication instead of division post.
  teaser_alt: A teaser image for the Multiplication instead of division post.
excerpt: we will examine in some detail why we consider research and experimentation
  to be the “peanut butter and jelly” of the customer insights world — two unique
  things that are even better together.
---
