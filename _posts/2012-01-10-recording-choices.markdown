...
> *Note: [Crossposting](https://en.wikipedia.org/wiki/Crossposting) here [from](https://blogs.oracle.com/rtd/en/entry/recording_choices) the [Oracle Real-Time Decisions Blog ](https://blogs.oracle.com/rtd/)where I have been [invited](https://blogs.oracle.com/rtd/en/entry/introducing_lukas_vermeer) to contribute.*
...
> *Note: Special thanks to Michel Adar for bringing this to my attention and providing an initial draft of this article.*
