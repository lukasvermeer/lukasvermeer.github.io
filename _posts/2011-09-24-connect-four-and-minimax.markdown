...
This is one of the reasons why we need a [super-computer](https://en.wikipedia.org/wiki/Deep_Blue_(chess_computer)) to beat a [chess grandmaster](https://en.wikipedia.org/wiki/Garry_Kasparov). There are a lot of possible moves to consider in a game of chess.

**[Winning](https://knowyourmeme.com/memes/winning).**

Another problem when programming computers to play a two-player [zero-sum game](https://en.wikipedia.org/wiki/Zero%E2%80%93sum_game) like chess, is that half of the decisions in the game are made by the opponent. The computer can decide which moves to make, but it has no control over what the opposing player does in response.
...
**[Mini and Maxi](https://www.youtube.com/watch?v=ePxdZ_qIQ4g).**
...
This approach is called [minimax](https://en.wikipedia.org/wiki/Minimax). It is not particularly clever, but it does the trick and is relatively easy to implement.

**Connect Four.**

Last year, a [Microsoft SharePoint](https://en.wikipedia.org/wiki/Microsoft_SharePoint) consultant I'd met at a customer site asked me to explain how to implement a computer opponent for a [Connect Four](https://en.wikipedia.org/wiki/Connect_Four) game he was creating for [Microsoft Windows Phone Mobile XP 7 Vista Home Edition](https://en.wikipedia.org/wiki/Windows_Phone) (or whatever they call it nowadays). Instead of explaining how, I decided to build a simple example myself in JavaScript using minimax. I don't think he ever finished his version of the game.

You can play my version here. Somewhat ironically, it is excruciatingly slow when using [Microsoft Internet Explorer](https://en.wikipedia.org/wiki/Internet_Explorer); so please consider using [any](https://www.apple.com/safari/download/) [other](https://www.mozilla.org/en-US/firefox/new/) [browser](https://www.google.com/chrome?hl=en).

* * *

**Update (June 29th 2012):** The code for this example is available [on Github](https://github.com/lukasvermeer/minimax).

**Update (July 5th 2012):** This is now available as a web service. Read [this post](https://lukasvermeer.wordpress.com/2012/07/05/connecting-four-in-the-cloud/).
