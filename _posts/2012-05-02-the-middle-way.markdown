...
header:
  alt: A teaser image for the The Middle Way post.
  teaser_alt: A teaser image for the The Middle Way post.
---

James Taylor is [spot-on](https://jtonedm.com/2012/04/05/is-machine-learning-v-domain-expertise-the-wrong-question/).
...
In order to truly achieve business transcendence one must follow the [Middle Way](https://en.wikipedia.org/wiki/Middle_way).
