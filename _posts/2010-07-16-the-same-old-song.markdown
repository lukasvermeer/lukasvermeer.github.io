...
The IMDb site offers [lots of different datasets for download](https://www.imdb.com/interfaces#plain), and we quickly found that one of them contains soundtrack listings (the aptly named file [soundtracks.list.gz](ftp://ftp.fu-berlin.de/pub/misc/movies/database/soundtracks.list.gz)). Now it was just a matter of filtering out the unnecessary contextual data and counting songs. Quickly Olav, who does datamining for a living, managed to get all this done using spiffy point-and-click tools. I proceeded to [ask twitter what people thought the answer would be](https://twitter.com/lukasvermeer/status/6962168925).
...
1.  ["Jingle Bells"](https://en.wikipedia.org/wiki/Jingle_Bells) (220x)
2.  ["William Tell Overture"](https://en.wikipedia.org/wiki/William_Tell_Overture) (204x)
3.  ["Home Sweet Home"](https://en.wikipedia.org/wiki/Home!_Sweet_Home!) (160x)
4.  ["Auld Lang Syne"](https://en.wikipedia.org/wiki/Auld_Lang_Syne) (149x)
5.  ["Rock-a-Bye Baby"](https://en.wikipedia.org/wiki/Rock-a-bye_Baby) (140x)
...
[^1]: Much later, a friend (can't remember exactly who) noted that the song that is played most often in theaters is probably not listed in the data set the IMDb provides. It's the [20th Century Fox intro](https://www.youtube.com/watch?v=LTgRm6Qgscc).
