...
While there remains [a considerable amount of controversy around the transfer of learnings](https://en.wikipedia.org/wiki/Transfer_of_learning), I've always personally believed that [certain mental skills can be transferred](https://ieet.org/index.php/IEET/more/kuszewski20110720) from one domain to another. My aspiration to learn to fashion authentic and articulate appraisals was part of the reason I started writing restaurant reviews in the first place.
