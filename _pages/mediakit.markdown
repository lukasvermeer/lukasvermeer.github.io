...
- url: "/assets/images/originals/headshot-lukas-2022.jpg"
  ...
  alt: A headshot of Lukas Vermeer (2022).
  title: Lukas (2022)
- url: "/assets/images/originals/headshot-lukas-2024.jpg"
  image_path: "/assets/images/headshot-lukas-2024-s.webp"
  alt: A headshot of Lukas Vermeer (2024).
  title: Lukas (2022)
gallery_action:
...
- url: "/assets/images/originals/action-booking-data-science-meetup-amsterdam-2017.jpg"
  ...
  alt: Lukas speaking while standing in the middle of a seated crowd at a Booking
    Data Science Meetup in Amsterdam, 2017.
...
{% include video id="648968790" provider="vimeo" title="Moving fast, breaking things, and fixing them as quickly as possible - Conversion Hotel" %}
...
{% include video id="376028124" provider="vimeo" title="One neat trick to run better experiments - Conversion Hotel" %}
...
{% include video id="271252248" provider="vimeo" title="Democratising Online Controlled Experiments at Booking.com - Mind the Product" %}
...
{% include video id="wcNwUNqTYc8" provider="youtube" title="Data Science vs. Data Alchemy - GOTO Conference" %}
